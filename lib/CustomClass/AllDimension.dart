class AllDimension {
  ...
  static double sixtyTwo = 62.0;
  static double sixtyFour = 64.0;
  static double sixtyEight = 68.0;
  static double seventy = 70.0;
  static double seventyTwo = 72.0;
  ...
  static double oneZeroFour = 104.0;
  static double oneTen = 110.0;
  static double oneTwenty = 120.0;
  static double oneThirty = 130.0;
  static double oneThirtyFour = 134.0;
  static double oneFourtyEight= 148.0;
  static double oneFifty = 150.0;
  static double oneSixty = 160.0;
  static double oneSixtyFive = 165.0;
  static double oneSeventyEight = 178.0;
  static double oneEighty = 180.0;
  static double oneEightyFour = 184.0;
  static double twoHundred = 200.0;
  static double twoEight = 208.0;
